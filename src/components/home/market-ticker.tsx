...
export default function MarketTicker() {
    ...
    return (
        <div className="w-full glass border-y border-white/5 overflow-hidden py-3 relative">
            {/* Fade edges */}
            <div className="absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-[#0f0f14] to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-[#0f0f14] to-transparent z-10 pointer-events-none" />
